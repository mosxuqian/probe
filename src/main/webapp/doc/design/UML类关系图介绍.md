...
![A继承自B](http://static.blinkfox.com/uml_jc.png)
...
![A实现B](http://static.blinkfox.com/uml_sx.png)
...
**关联**关系是用一条**可能会有方向的直线**表示的。关联关系默认不强调方向，表示对象间相互知道；如果特别强调方向，如上图，表示A知道B，但B不知道A；如下图所示：

![A关联B](http://static.blinkfox.com/uml_gl.png)
...
![A聚合到B](http://static.blinkfox.com/uml_jh.png)
...
![A组合到B](http://static.blinkfox.com/uml_zh.png)
...
![A依赖于B](http://static.blinkfox.com/uml_yl.png)
...
![UML示例](http://static.blinkfox.com/uml_example.png)
