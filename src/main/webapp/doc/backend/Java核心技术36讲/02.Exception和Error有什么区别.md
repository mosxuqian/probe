...
![Java异常结构图](http://static.blinkfox.com/javahxjs_02_01.png)
...
很多开源项目，已经采纳了这种实践，比如 Spring、Hibernate 等，甚至反映在新的编程语言设计中，比如 Scala 等。 如果有兴趣，你可以参考[这里](http://literatejava.com/exceptions/checked-exceptions-javas-biggest-mistake/)。
