# Java8字符串处理库strman-java的学习和使用

标签：Java

## 一、介绍

> [strman-java][1]是Java8的字符串处理库，它的灵感来自[dleitee/strman][2]。
...
[1]: https://github.com/shekhargulati/strman-java
[2]: https://github.com/dleitee/strman
